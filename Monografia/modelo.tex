...
\titulo{T\'itulo do trabalho} %%Por exemplo, Titulo da tese
...
\local{Juiz de Fora}
\data{2014} %%Alterar o ano se precisar
\orientador[Orientador:]{Nome do orientador} %%Se precisar, troque [Orientador:] por [Orientadora:]
...
\programa{Programa de P\'os\mbox{-Gra}dua\c{c}\~ao em Matem\'atica} %%Alterar, dentro de chaves {}, se precisar.
\objeto{Disserta\c{c}\~ao (Mestrado)}  %%Tese (Doutorado)
\natureza{Disserta\c{c}\~ao  %%Tese
apresentada ao \insereprograma ~da Universidade Federal de Juiz de Fora, na \'area de concentra\c{c}\~ao 
em %%PREENCHER 
, como requisito parcial para obten\c{c}\~ao do t\'itulo de Mestre em  %% Doutor em
